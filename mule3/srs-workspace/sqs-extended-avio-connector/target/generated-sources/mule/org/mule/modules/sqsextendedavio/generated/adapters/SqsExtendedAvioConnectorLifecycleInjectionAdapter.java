...
/**
 * A <code>SqsExtendedAvioConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link SqsExtendedAvioConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.4", date = "2019-12-12T02:29:27-06:00", comments = "Build UNNAMED.2810.4347dd1")
public class SqsExtendedAvioConnectorLifecycleInjectionAdapter
    extends SqsExtendedAvioConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(SqsExtendedAvioConnectorLifecycleInjectionAdapter.class);
